...
INSERT INTO RM_PROJECT (id, code, name, description, owner_user_id)
VALUES ('0', 'test1', '测试项目1', '这是一个测试项目1', '0'),
       ('1', 'test2', '测试项目2', '这是一个测试项目2', '0'),
       ('2', 'test3', '测试项目3', '这是一个测试项目3', '0'),
       ('3', 'test4', '测试项目4', '这是一个测试项目4', '0'),
       ('4', 'test5', '测试项目5', '这是一个测试项目5', '0'),
       ('5', 'test6', '测试项目6', '这是一个测试项目6', '0'),
       ('6', 'test7', '测试项目7', '这是一个测试项目7', '0'),
       ('7', 'test8', '测试项目8', '这是一个测试项目8', '0');

INSERT INTO RM_STAGE (id, project_id, name, previous_id, next_id)
VALUES ('0', '0', '需求列表', null, '1'),
       ('1', '0', '代办任务', null, '2'),
       ('2', '0', '开发中', null, '3'),
       ('3', '0', '测试中', null, '4'),
       ('4', '0', '已完成', null, null);

INSERT INTO RM_TASK (id, project_id, stage_id, content, status, previous_id, next_id) VALUES
('0', '0', '0', '这是一个任务1', '', null, '1'),
('1', '0', '0', '这是一个任务2', '', null, '2'),
('2', '0', '0', '这是一个任务3', '', null, '3'),
('3', '0', '0', '这是一个任务4', '',null, null);